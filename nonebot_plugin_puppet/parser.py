...
link_parser = puppet_subparsers.add_parser("link", help= "Link conversation what you want")
...
unlink_parser = puppet_subparsers.add_parser("unlink", help="Unlink current conversation")
